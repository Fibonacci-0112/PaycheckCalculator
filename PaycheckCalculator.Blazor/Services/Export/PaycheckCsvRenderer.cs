...
/// the Results panel (Income, Taxes, Deductions, Summary); an optional
/// <see cref="AnnualProjection"/> and an optional A/B <see cref="ComparisonRow"/>
...
public static class PaycheckCsvRenderer
{
    ...
    /// <param name="annual">Optional annual projection appended after the per-period rows.</param>
    /// <param name="comparison">Optional A/B comparison rows appended as a second table.</param>
    /// <param name="comparisonNameA">Heading for the comparison's first value column.</param>
    /// <param name="comparisonNameB">Heading for the comparison's second value column.</param>
    ...
    private static void WriteAnnual(StringBuilder sb, AnnualProjection a)
    {
