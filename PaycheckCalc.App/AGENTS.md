# AGENTS.md - PaycheckCalc.App

Scope: this file applies to everything under `PaycheckCalc.App/`.

## Role of this project

`PaycheckCalc.App` is the .NET MAUI client for Android and Windows. It presents the calculator, results, saved paychecks, budget features, account/sync screens, export, print, and local offline storage. The calculation truth lives in Core; this project adapts that truth to a native UI.
...
dotnet build PaycheckCalc.App -f net11.0-android
dotnet build PaycheckCalc.App -f net11.0-windows10.0.19041.0
```
