# AGENTS.md - PaycheckCalc.Blazor

Scope: this file applies to everything under `PaycheckCalc.Blazor/`.

## Role of this project

`PaycheckCalc.Blazor` is the Blazor Server front-end. It exposes the paycheck calculator, annual projection, saved paycheck comparison, budget features, account/session UI, exports, print support, and public state landing pages using Core and Shared services.
...
dotnet test PaycheckCalc.Tests --filter "FullyQualifiedName~Export"
```
