...
internal static class PaycheckPdfRenderer
{
        ...
        string comparisonNameA = "Paycheck A", string comparisonNameB = "Paycheck B")
    {
        ...
        if (result.QuarterlyEstimates.Count > 0)
            WriteQuarterlyEstimates(layout, result.QuarterlyEstimates);
        ...
        WriteAccuracyNotes(
            ...
            result.Explanation.AccuracyNotes
                ...
                .Concat(annual?.AccuracyNotes ?? Array.Empty<PaycheckCalculator.Core.Explanation.AccuracyNote>())
                .Distinct()
                .ToList());
    ...
    private static void WriteAccuracyNotes(
        PdfLayout layout,
        IReadOnlyList<PaycheckCalculator.Core.Explanation.AccuracyNote> notes)
    {
    ...
    private static void WriteQuarterlyEstimates(
        PdfLayout layout,
        IReadOnlyList<PaycheckCalculator.Core.Models.QuarterlyEstimate> quarters)
    {
